...
Important note: the final audit confirms the folder-level evidence set is complete. Detailed linking analysis is complete for all 10 poles. The notes cleanup merged in commit e22c733 reconciled poles 02, 07, and 10 with their ENWL popup and field photo evidence; all 10 poles now have substantive notes with confirmed support numbers, ENWL FID, and SPN. Conductor and equipment linking remains conservative throughout.
...
| 02 | 902201 | 16793152 | 61090H02201 | 11kV route confirmed from ENWL popup; Section pole in sequence between supports 902202 and 900343 | Strong: ENWL popup confirms FID 16793152, SPN 61090H02201, Section / Single Wood Pole, support 902201; field photos and ENWL screenshots present | None identified; no `fid_polestructure` equipment link in current notes | Route-level HV conductor and route label evidence in ENWL screenshots; 11kV context consistent with adjacent poles; not span-linked | Nearby HV sleeve/overhead termination captured as route context only; not proven directly attached to pole | HIGH identity; MEDIUM route linkage | Exact conductor FID-to-span relationship; access/permission status; any stay/downlead detail; pole strength class/design rating |
...
| 07 | 903104 | 53426793 | 61090L03104 | Separate LV branch confirmed from ENWL popup; Terminal pole on the 903101-903104 LV residential-side route | Strong: ENWL popup confirms FID 53426793, SPN 61090L03104, Terminal / Single Wood Pole, support 903104; field photos and ENWL screenshots present | None identified; no `fid_polestructure` equipment link in current notes | LV route conductor and route label evidence in ENWL screenshots; 415V LV context consistent with adjacent LV poles; not span-linked | Nearby LV sleeve/overhead termination captured as route context only; not proven directly attached to pole | HIGH identity; MEDIUM LV route linkage | Exact LV conductor FID-to-span relationship; any stay/terminal hardware confirmation; pole strength class/design rating |
...
| 10 | 903101 | 16788439 | 61090L03101 | Separate LV branch confirmed from ENWL popup; Section pole on the 903101-903104 LV residential-side route | Strong: ENWL popup confirms FID 16788439, SPN 61090L03101, Section / Single Wood Pole, support 903101; field photos and ENWL screenshots present | None identified; no `fid_polestructure` equipment link in current notes | LV route conductor and route label evidence in ENWL screenshots; route label `2x .06 Cu` in nearby context; not span-linked | sleeve_lv FID 61933103 (415V, Mains LV, Three Phase); exact attachment to this pole not proven | HIGH identity; MEDIUM LV route linkage | Exact LV conductor FID-to-span relationship; sleeve_lv FID 61933103 relationship to this pole; cable guard/downlead purpose; pole strength class/design rating |

## Key Findings

### 1. Which poles have strong direct pole identity evidence?

Strong Level 1 pole identity evidence is now present in the notes for all 10 poles. Following the notes cleanup merged in commit e22c733, poles 02, 07, and 10 have been reconciled with their ENWL popup and field photo evidence.

- Poles 01, 03, 04, 05, 06, 08, 09: confirmed from ENWL popup, visible field plate/marking, GPS/map pin, and field-photo evidence.
- Pole 02 / support 902201: confirmed FID 16793152, SPN 61090H02201, Section / Single Wood Pole from ENWL popup; ENWL screenshots and field photos present.
- Pole 07 / support 903104: confirmed FID 53426793, SPN 61090L03104, Terminal / Single Wood Pole from ENWL popup; ENWL screenshots and field photos present.
- Pole 10 / support 903101: confirmed FID 16788439, SPN 61090L03101, Section / Single Wood Pole from ENWL popup; ENWL screenshots and field photos present.

Conductor and equipment linking remains conservative for all three: no `fid_polestructure` equipment link has been identified in the notes, and all conductor evidence remains Level 3 route/span evidence only.
...
- 11kV Jolly's Farm / Station Road route: poles 01, 02, 03, 04, 05, and 06 are all documented as 11kV route evidence. Pole 02 / support 902201 is confirmed from ENWL popup as a Section pole in this 11kV route sequence.
- Separate LV / residential-side route: poles 07, 08, 09, and 10 are all documented as part of the separate LV route around Sheernest Lane / Station Road, with supports 903101, 903102, 903103, and 903104. Pole 07 / support 903104 is confirmed as Terminal from ENWL popup; Pole 10 / support 903101 is confirmed as Section from ENWL popup.
...
Stage 6A should flag note-level inconsistencies where evidence is incomplete or provisional. Following the notes cleanup in commit e22c733, all 10 poles now have substantive notes; the earlier mismatch between audit support numbers and placeholder note content has been resolved.
