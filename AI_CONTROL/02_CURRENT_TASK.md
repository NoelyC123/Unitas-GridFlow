...
- Validation result: `pytest -v` passed, 931 passed, 1 skipped; `pre-commit run --all-files` passed
...
- Add regression tests proving Stage 4 remains out of C2E2 popups and Review OS/map-viewer runtime behaviour.
...
Commit, rerun repo health and merge safety on the committed branch, and hand back for review/merge.
