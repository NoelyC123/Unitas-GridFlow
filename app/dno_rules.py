...
BASE_RULES = [
    ...
    {"check": "equipment_expected_transformer"},
    {"check": "connectivity_span_endpoints"},
    {"check": "connectivity_reference_ids"},
    {"check": "connectivity_stay_parent"},
    {"check": "survey_metadata_advisory"},
